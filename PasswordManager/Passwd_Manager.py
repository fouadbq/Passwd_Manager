...
def Encrypt_Passwrds_Record():
    ...
    with open('Passwords_Register.json', 'rb') as file:        
    ...
    with open('Passwords_Register.json', 'wb') as file:
...
def init():
    ...
    with open('UserPassword.hash', 'w') as user_password_file:
        user_password_file.write(hash(UserPassword))

    # Create  a passwords register file
    with open('Passwords_Register.json', 'w') as password_register:
...
def authenticate_user():
    for i in range(3):
        ...
        with open('UserPassword.hash', 'r') as user_password_file:
...
def generate_new_password(len):
    ...
    passwords_list = []
    with open('Passwords_Register.json', 'r') as register_file:
...
def Create_New_Password():
    ...
    if not Service_Exists(argv[3]):
        ...
        with open('Passwords_Register.json', 'r') as Passwords_Register:
        ...
        with open('Passwords_Register.json', 'w') as Passwords_Register:
